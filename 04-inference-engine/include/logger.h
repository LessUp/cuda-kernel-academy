...
// Logging macros
#define LOG_TRACE(...) mini_inference::Logger::instance().log(mini_inference::LogLevel::TRACE, __FILE__, __LINE__, __VA_ARGS__)
#define LOG_DEBUG(...) mini_inference::Logger::instance().log(mini_inference::LogLevel::DEBUG, __FILE__, __LINE__, __VA_ARGS__)
#define LOG_INFO(...)  mini_inference::Logger::instance().log(mini_inference::LogLevel::INFO,  __FILE__, __LINE__, __VA_ARGS__)
#define LOG_WARN(...)  mini_inference::Logger::instance().log(mini_inference::LogLevel::WARN,  __FILE__, __LINE__, __VA_ARGS__)
#define LOG_ERROR(...) mini_inference::Logger::instance().log(mini_inference::LogLevel::ERROR, __FILE__, __LINE__, __VA_ARGS__)
#define LOG_FATAL(...) mini_inference::Logger::instance().log(mini_inference::LogLevel::FATAL, __FILE__, __LINE__, __VA_ARGS__)
