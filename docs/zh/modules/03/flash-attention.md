...
`03-hpc-advanced` 只讲 tiling 与 online softmax。完整前后向、WMMA、FlashDecoding 与实测数字见 [cuflash](https://github.com/open-infra-ai/cuflash)。Triton 参考实现见 [trifuse](https://github.com/open-infra-ai/trifuse)。
:::
